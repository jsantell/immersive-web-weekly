...
class App extends App$1 {
  init() {
    ...
    const mountainMat = new BarycentricMaterial({
      color: new THREE.Color(0x222222),
      wireframeColor: new THREE.Color(0xb450ce),
      alpha: 1,
      wireframeAlpha: 1,
      width: 2,
